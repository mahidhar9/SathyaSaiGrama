...
const FillInvitation = ({ navigation }) => {
  ...
  const generateQR = async passcodeData => {
    try {
      ...
      const qrUrl = `https://qr-code-invitation-to-visitor.onrender.com/generate-image?name=${loggedUser.name
    ...
    if (validateForm()) {
      ...
      try {
        ...
        setIsSubmitted(false);
         navigation.navigate('DailyVisitorScreen');
