...
describe('VerifyDetails Component', () => {
  ...
  test('Verify that the  L1 can able to edit the details after L2 approved', async () => {
    ...
    await waitFor(() => {
       expect(queryAllByText("Can not edit details once Visitor is L2 approved")).toBeTruthy();
      expect(queryAllByText("Please fill another form")).toBeTruthy();
    });
  });
});