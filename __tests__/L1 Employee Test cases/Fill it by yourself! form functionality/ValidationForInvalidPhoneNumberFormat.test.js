...
describe('FillByYourSelf Component', () => {
  ...
  const mockUserContext = {
    ...
    loggedUser: { name: 'Test User', resident: true, employee: true, role: 'L1', deptIds: [] },
  ...
  test('test_invalid_phone_number_format', async () => {
    ...
    fireEvent.changeText(phoneInput, '+91 987654321');
